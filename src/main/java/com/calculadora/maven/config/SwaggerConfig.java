package com.calculadora.maven.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket simpleDiffServiceApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apiInfo(apiInfo())
				.select()
                .apis(RequestHandlerSelectors.basePackage("com.calculadora.maven.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Swagger Calculadora")
				.description("Sirve para comprobar la funcionalidad de las distintas cuentas")
				.version("1.0")
				.build();
	}
